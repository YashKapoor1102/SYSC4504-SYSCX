...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2024 at 11:09 AM
...
CREATE DATABASE IF NOT EXISTS yash_kapoor_syscx;
USE yash_kapoor_syscx;

--
-- Database: `yash_kapoor_syscx`
--
...
CREATE TABLE `users_posts` (
  ...
  `student_id` int(10) NOT NULL,
  `new_post` text NOT NULL CHECK (char_length(`new_post`) <= 1000),
...
--
ALTER TABLE `users_info`
  MODIFY `student_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100153;
...
--
ALTER TABLE `users_permissions`
  ADD CONSTRAINT `fk_users_permissions_student_id` FOREIGN KEY (`student_id`) REFERENCES `users_info` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;
